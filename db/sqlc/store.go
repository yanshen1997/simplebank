...
type Store interface {
	Querier
	TransferTx(ctx context.Context, tp TransferTxParam) (TransferTxResult, error)
}
...
func (store *SQLStore) TransferTx(ctx context.Context, tp TransferTxParam) (TransferTxResult, error) {
